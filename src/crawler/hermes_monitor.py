...
class HermesMonitor(Monitor):
    ...
    def init_params():
        ...
        headers = {
            ...
            'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjEzNDc5NjQiLCJhcCI6IjQ3NzY4NjUwMSIsImlkIjoiMTlhNWRjNzE5YmVlNGEyOSIsInRyIjoiNDk4MzZkYTQ1MzMxYmE3NDE1ZmU3Yjc5NDhkOGY4YzIiLCJ0aSI6MTc0OTEyNjI1NzgxM319',
            'pragma': 'no-cache',
            'priority': 'u=0, i',
            'referer': 'https://www.hermes.com/hk/en/category/women/bags-and-small-leather-goods/luggage/',
            ...
            'traceparent': '00-49836da45331ba7415fe7b7948d8f8c2-19a5dc719bee4a29-01',
            'tracestate': '1347964@nr=0-1-1347964-477686501-19a5dc719bee4a29----1749126257813',
